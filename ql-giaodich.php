...
if ($querygiaodich && $querygiaodich->num_rows > 0)
    ...
    header("Location: ./themgiaodich.php?may=" . $_GET['may']);
...
if (isset($_POST['submit'])) {
    ...
    if ($query){
        echo "<script>Swal.fire('Thành công!','Đã lưu thanh toán!','success').then(function(){window.location = './admin.php';});</script>";
    }
    else {
