...
<head>
    ...
    <title>Đăng ký</title>
    <link href="assets/img/logo-the-thao-dep.jpg" rel="icon">
    ...
    <main id="main" class="register-page">
        <section id="hero" class="d-flex align-items-center">
            <div class="container-fluid col-lg-5 col-md-8 mb-5">
                <div class="row bg-white my-1 rounded-top rounded-3 title">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 title-N3">
                        <h1 class="text-center text-primary">N3NET</h1>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 title-detai">
                        <h3 class="text-center text-primary mt-3">QUẢN LÝ TIỆM NET</h3>
                    </div>
                </div>
                <div class="row bg-white pt-4 pb-5 rounded-bottom rounded-3 register-text">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 text-center">
                        <img width="200px" height="100%" src="./assets/img/logo.jpg" alt="">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 btn-register">
                        <h3 class="text-primary mb-4">Register</h3>
                        <form method="post" onsubmit="return validateForm()" name="myForm">
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group form-group">
                                        <div class="input-group-prepend icon-tk">
                                ...
                                <div class="col-12">
                                    <div class="input-group form-group">
                                        <div class="input-group-prepend icon-mk">
                                ...
                                <div class="col-12">
                                    <div class="input-group form-group">
                                        <div class="input-group-prepend icon-lmk">
                                            <span class="input-group-text"><i class="fa fa-rotate-left"></i></span>
                                        </div>
                                        <input type="password" name="nhaplaipassword" id="nhaplaipassword"
                                ...
                                <div class="col-md-6 pr-0 register-button">
                                    <button type="submit" name="dangky" class="btn btn-primary px-4">
                                        <i class="fa fa-user-plus"></i> Đăng ký</button>
                                </div>
                                <div class="col-md-6 pr-0 login-a">
                                    <a class="btn btn-success px-4" href="./dangnhap.php">
